...
<section class="product_details_area p_100">
    <div class="container">
        <div class="row product_d_price">
            <div class="col-lg-6">
                <div class="product_img"><img class="img-fluid" src="source/image/product/{{$sanpham->image}}" alt=""></div>
            </div>
            <div class="col-lg-6">
                <div class="product_details_text">
                    <h4>{{$sanpham->name}}</h4>
                    <p>{{$sanpham->description}}</p>
                    <h5>Price :<span>{{$sanpham->unit_price}}</span></h5>
...
<section class="similar_product_area p_100">
    <div class="container">
        ...
        <div class="row similar_product_inner">
            @foreach($similar as $sptt)
            <div class="col-lg-3 col-md-4 col-6">
                <div class="cake_feature_item">
                    <div class="cake_img">
                        <img height="226px" src="source/image/product/{{$sptt->image}}" alt="">
                    </div>
                    <div class="cake_text">
                        <h4>{{$sptt->unit_price}}</h4>
                        <a href="" title=""></a><h3>{{$sptt->name}}</h3>
...
{{--         <div class="row">{{$similar->links()}}</div> --}}
        <div class="product_pagination">
            ...
            <div class="middle_list">
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item"><a class="page-link" href="#">{{$similar->links()}}</a></li>
                    </ul>
