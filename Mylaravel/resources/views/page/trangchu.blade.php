        ...
        @foreach ($new_product as $new)
            <div class="col-lg-3 col-md-4 col-6">
                <div class="cake_feature_item">
                    <div class="cake_img">
                      <img height="226px"  src="source/image/product/{{$new->image}}"  >
                    </div>
                    <div class="cake_text">
                        <h4>{{$new->unit_price}}</h4>
                        <a href="{{route('chitietsanpham',$new->id)}}" title=""><h3>{{$new->name}}</h3></a>
                        <a class="pest_btn" href="{{route('themgiohang',$new->id) }}">Add to cart</a>
                    </div>
                </div>
            </div>
        @endforeach
