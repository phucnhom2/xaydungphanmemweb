        ...
        <?php $__currentLoopData = $new_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-4 col-6">
                <div class="cake_feature_item">
                    <div class="cake_img">
                      <img height="226px"  src="source/image/product/<?php echo e($new->image); ?>"  >
                    </div>
                    <div class="cake_text">
                        <h4><?php echo e($new->unit_price); ?></h4>
                        <a href="<?php echo e(route('chitietsanpham',$new->id)); ?>" title=""><h3><?php echo e($new->name); ?></h3></a>
                        <a class="pest_btn" href="<?php echo e(route('themgiohang',$new->id)); ?>">Add to cart</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-7">
                <div class="arivals_chocolate">
                    <div class="arivals_pic">
                        <img class="img-fluid" src="source/img/cake-feature/arivals-pic.jpg" alt="">
            ...
            <div class="col-lg-6">
                <div class="arivals_slider owl-carousel">
                    <div class="item">
                        <div class="cake_feature_item">
                            <div class="cake_img">
                                <img src="source/img/cake-feature/arivals-1.jpg" alt="">
                            </div>
                            <div class="cake_text">
                                <h4>$29</h4>
                    ...
                    <div class="item">
                        <div class="cake_feature_item">
                            <div class="cake_img">
                                <img src="source/img/cake-feature/arivals-2.jpg" alt="">
                            </div>
                            <div class="cake_text">
                                <h4>$29</h4>
