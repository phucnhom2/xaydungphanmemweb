        ...
        <div class="container">
            ...
            <div class="float-right">
                ...
                <ul class="h_search list_style">
                    ...
                    <li class=""><a href="<?php echo e(route('login')); ?>"><i class="lnr lnr-users"></i></a></li>
                    <li class=""><a href="<?php echo e(route('signin')); ?>"><i class="lnr lnr-user"></i></a></li>
    ...
    <div class="main_menu_two">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="index.html"><img src="source/img/logo-2.png" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li><a href="<?php echo e(route('trang-chu')); ?>">Cakes</a></li>
                    ...
                    <li class="droshop_capdown submenu">
