                        ...
                        <div class="row product_item_inner">
                            ...
                            <div class="col-lg-4 col-md-4 col-6">
                                <div class="cake_feature_item">
                                    <div class="cake_img">
                                        <img height="226" src="source/image/product/<?php echo e($sp->image); ?>" alt="">
                                    </div>
                                    <div class="cake_text">
                                        <h4><?php echo e($sp->unit_price); ?></h4>
                                        <a href="<?php echo e(route('chitietsanpham',$sp->id)); ?>" ><h3><?php echo e($sp->name); ?></h3></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product_left_sidebar">
                            ...
                            <aside class="left_sidebar p_catgories_widget">
                                <div class="p_w_title">
                                    <h3>Product <?php echo e($loai_sp->name); ?></h3>
                                </div>
                                <ul class="list_style">
